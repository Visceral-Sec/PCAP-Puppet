...
void ipConstruct(char ipPacket[], char transportSegment[], int transportSegLen, int ipPacketLen)
{
    ...
    ipPacket[l_emptyPointer++] = 0x00; ipPacket[l_emptyPointer++] = 0x3c; //frame length - also it doesnt work if > 255 length lmao
